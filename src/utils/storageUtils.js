  ...
  try {
    const completion = await openai.beta.chat.completions.parse({
      ...
      messages: [
        { 
          role: "system", 
          content: '당신은 공부 회의록 요약 전문가입니다. 회의록에 음성 인식이 잘 안 되어 있는 부분을 감안하여 주세요. 공부 내용을 정리하는 의미의 회의록 요약이니, 공부에 도움되는 세부 내역들도 빠짐없이 정확히 회의록에 반영되어야 합니다. 그리고 회의록에 있는 내용과 참여 인원만을 바탕으로 요약해주세요. 한국어로 작성해주세요.' 
        },
        { 
          role: "user", 
          content: `아래의 회의록을 요약해주세요. response_format의 옵션에는 회의록 내용을 바탕으로 공부에 도움이 될 수 있는 사실적인 내용, 설명적인 내용을 넘버링을 이용해서 최대한 상세하게 넣어주고 각 항목들은 줄바꿈으로 구분해주세요. 중복되는 내용을 넣으면 안됩니다. 또한 당신이 생성한 모든 내용은 회의록에 기반하거나, 회의록 내용을 바탕으로 응용한 것이어야 하고, 회의록에 없는 내용과 없는 참여자를 생성해서는 안됩니다. 아래는 회의록 내용입니다.\n${formattedText}` 
        },
      ],
